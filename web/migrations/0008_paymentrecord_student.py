# Generated by Django 2.2.3 on 2020-08-12 05:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='web.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
            fields=[
                ...
                ('class_list', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.ClassList', verbose_name='申请班级')),
                ('confirm_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='confirms', to='web.UserInfo', verbose_name='审批人')),
                ('consultant', models.ForeignKey(help_text='谁签的单就选谁', on_delete=django.db.models.deletion.DO_NOTHING, to='web.UserInfo', verbose_name='课程顾问')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.Customer', verbose_name='客户')),
            ],
        ),
    ]
