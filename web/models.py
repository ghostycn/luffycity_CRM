...
class ClassList(models.Model):
    ...
    """
    school = models.ForeignKey(verbose_name="校区",to="School",on_delete=models.DO_NOTHING)
...
class PaymentRecord(models.Model):
    ...
    缴费申请
    """
    customer = models.ForeignKey(Customer, verbose_name="客户",on_delete=models.DO_NOTHING)
    ...
    confirm_user = models.ForeignKey(verbose_name="审批人", to='UserInfo', related_name='confirms', null=True, blank=True,on_delete=models.DO_NOTHING)
...
class Student(models.Model):
    ...
    学生表
    """
    customer = models.OneToOneField(verbose_name='客户信息', to='Customer',on_delete=models.DO_NOTHING)
...
class ScoreRecord(models.Model):
    ...
    user = models.ForeignKey(verbose_name='执行人', to='UserInfo',on_delete=models.DO_NOTHING)

class CourseRecord(models.Model):
    """
    上课记录表
    """
    class_object = models.ForeignKey(verbose_name="班级", to="ClassList",on_delete=models.DO_NOTHING)
    day_num = models.IntegerField(verbose_name="节次")
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',on_delete=models.DO_NOTHING)
...
class StudyRecord(models.Model):
    ...
    学生考勤记录
    """
    course_record = models.ForeignKey(verbose_name="第几天课程", to="CourseRecord",on_delete=models.DO_NOTHING)
    student = models.ForeignKey(verbose_name="学员", to='Student',on_delete=models.DO_NOTHING)
    record_choices = (
        ('checked', "已签到"),
        ('vacate', "请假"),
        ('late', "迟到"),
